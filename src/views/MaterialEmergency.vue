<template>
        ...
        <div class="search">
          <div class="search-left">
            <el-input
              ...
              size="large"
              class="ipt-search"
              placeholder="根据物资名称查询"
            ></el-input>
  
            <el-button type="primary" @click="search" size="large">搜索</el-button>
          </div>
          <el-button type="primary" @click="jobReport" size="large">添加救援物资</el-button>
          <el-dialog title="添加救援物资" v-model="dialogFormVisible" width="50%">
            <el-form :model="addForm" size="mini">
              ...
              <el-form-item label="物资描述" :label-width="formLabelWidth">
  ...
  import { getEmergencyResource } from '@/api/api'
  let form = reactive({
    name: ''
  })
  onMounted(()=>{
    console.log(1234);
    getEmergencyResource().then(response=>{
